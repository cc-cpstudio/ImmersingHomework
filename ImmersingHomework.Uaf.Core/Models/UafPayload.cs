...
using ImmersingHomework.Uaf.Core.Helpers;

namespace ImmersingHomework.Uaf.Core.Models;
...
public sealed record UafPayload
{
    ...
    [SetsRequiredMembers]
    public UafPayload(string subject, string date, string content, IReadOnlyList<string> tags)
    {
        Subject = subject;
        Date = date;
        Content = content;
