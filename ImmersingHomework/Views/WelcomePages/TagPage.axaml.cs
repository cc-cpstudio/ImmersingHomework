...
{
    private readonly ILogger _logger = Log.ForContext<TagPage>();
    private static readonly List<Avalonia.Media.Color> PredefinedColors = new List<Avalonia.Media.Color>
    {
        Avalonia.Media.Color.FromRgb(220, 240, 255),
        Avalonia.Media.Color.FromRgb(255, 240, 220),
        Avalonia.Media.Color.FromRgb(220, 255, 220),
        Avalonia.Media.Color.FromRgb(255, 220, 240),
        Avalonia.Media.Color.FromRgb(240, 240, 220),
        Avalonia.Media.Color.FromRgb(240, 220, 255),
        Avalonia.Media.Color.FromRgb(255, 220, 220),
        Avalonia.Media.Color.FromRgb(220, 255, 240)
    };

    public TagPage()
    {
        _logger.Debug("TagPage 初始化");
        InitializeComponent();
        Refresh();
    }
